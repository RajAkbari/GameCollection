...
{
    public abstract class UserDALBase:DatabaseConfig
    {
            ...
            using (SqlConnection objConn = new SqlConnection(ConnectionString))
            {
                ...
                using (SqlCommand objCmd = objConn.CreateCommand())
                {
                    try
                    {
                        ...
                        objCmd.Parameters.AddWithValue("@FullName", entUser.FullName);
                        objCmd.Parameters.AddWithValue("@MobileNo", entUser.MobileNo);
                        objCmd.Parameters.AddWithValue("@EmailID", entUser.EmailID);
                        ...
                        using (SqlDataReader objSDR = objCmd.ExecuteReader())
                        {
                            while (objSDR.Read())
                            {
                                ...
                                if (objSDR["FullName"].Equals(DBNull.Value))
                                    entUser.FullName = Convert.ToString(objSDR["FullName"]);
                                ...
                                if (objSDR["EmailID"].Equals(DBNull.Value))
                                    entUser.EmailID = Convert.ToString(objSDR["EmailID"]);
                            }
                        }
                        return entUser;
